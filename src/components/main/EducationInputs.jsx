...
export default function EducationInputs(props) {

	const saveJobData = () => {
		flushSync(() => {eduData.push(props.dataEdu)})
		props.setEduData({...props.dataEdu, degree: '', city: '', school: '', description: '', start: 2015, end: 2022, id: crypto.randomUUID()})
		props.setShowEdu(false)
	}
	
	const handleData = (e) => {
		const name = e.target.name
		const value = e.target.value
		props.setEduData((prev) => {
			...
			<main className={styles.expMain}>
				...
				<div className={styles.section4}>
					<TextFieldMain 
						...
						dataEdu={props.dataEdu}
						direction={'eduDescription'}
					/>
					<div className={styles.buttonsContainer}>
						<AlertDialog direction={'edu'}/>
